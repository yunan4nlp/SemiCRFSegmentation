...
public:
	bool initial(HyperParams& hyper_params, AlignedMemoryPool* mem){
		...
		_tanh2_project.initial(hyper_params.hiddenSize1, hyper_params.rnnHiddenSize, hyper_params.rnnHiddenSize, true, mem);
		_seglayer_project.initial(hyper_params.segHiddenSize, hyper_params.hiddenSize2, hyper_params.hiddenSize2, mem);
